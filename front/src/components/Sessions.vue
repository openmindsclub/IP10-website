            ...
            <b-container fluid>
                <b-row align-v="center" align-h="center">
                    <b-col xl="8" lg="10" md="12">
                        <Paragraph :title="conf1.title" :content="conf1.content" time=true :begin="conf1.timeBegin" :end="conf1.timeEnd"/>
                    </b-col>
                </b-row>
                <b-row align-v="center" align-h="center">
...
export default {
  ...
  data: () => ({
      ...
      panel1 : {
          title: "Panel: L'impact de l’open source dans le développement des nouvelles technologies en Algérie et dans le monde",
      ...
      panel2 : {
          title: "Panel: Comment l’open source peut améliorer la croissance des entreprises en Algérie",
